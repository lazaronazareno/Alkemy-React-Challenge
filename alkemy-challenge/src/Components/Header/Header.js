    ...
    return (
        <header className="container-fluid d-flex position-absolute top-0 bg-primary border-bottom">
                ...
                <div className="list-group list-group-horizontal d-flex" role="group" aria-label="Basic outlined example">
                    ...
                    <Link className="list-group-item list-group-item-action d-flex text-center text-dark align-items-center list-group-item-warning" to="/team">
                         My Team 
                    </Link> 
                    {props.button.button === true && (
                        <Link className="list-group-item list-group-item-action d-flex text-center text-dark align-items-center list-group-item-warning"
                         to="/"
                         onClick={onclick}
                        >Logout
                        </Link>
